  ...
  return (
    <div className="map-layout">
      <div className="map-close">
        <PrimaryButton title="Назад" variant="secondary" onClick={() => navigate("/cart")} />
      </div>
      ...
      <section className="card map-panel">
        ...
        <div className="map-action">
          <PrimaryButton
            title={submitting ? "Отправляем..." : "Подтвердить"}
            onClick={confirmOrder}
            disabled={submitting || loadingAddress || cart.length === 0 || !!mapLoadError}
          />
        </div>
      </section>
    </div>
